package com.noidfrx.aprendiendo_android_s9_mymail.model;
...
public class Util {
    ...
    public static String getRandomColor(){
        int cantidadColores = coloresDisponibles.length;

        /* Para número aleatorio +1 para que no de 0*/

        int numeroAleatorio = new Random().nextInt(cantidadColores);
